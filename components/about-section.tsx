      ...
      <div className="royal-container">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-6" itemProp="knowsAbout">
              {[
                {
                  icon: Brain,
                  title: "AI-Driven Solutions",
                  description: "Leveraging AI tools to build smart, responsive, and efficient web applications.",
                  skills: ["OpenAI", "HuggingFace", "APIs"],
                ...
                },
                {
                  ...
                  title: "Dashboard",
                  description: "Creating powerful web experiences using minimal code and automation platforms.",
                  skills: ["n8n", "V0", "Bubble", "Claude"],
                  color: "text-sky-400",
                  delay: 0.2,
                },
                {
                  icon: Cloud,
                  title: "Cloud-Powered Deployments",
                  description: "Deploying scalable web apps using modern cloud platforms and AI integrations.",
                  skills: ["Vercel", "Firebase", "Render", "Cloudflare"],
                  color: "text-cyan-400",
                  delay: 0.3,
                },
                {
                  icon: ShieldCheck,
                  title: "Cybersecurity",
                  description: "Integrating secure practices into AI tools and platforms for safe user experiences.",
                  skills: ["OWASP", "Red & Blue Team Tools", "Data Privacy"],
                ...
                >
                  <Card className="royal-card h-full transition-all duration-300 group-hover:shadow-2xl">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-300 mb-4 leading-relaxed" itemProp="description">
                        {item.description}
                      </p>
