...
import { Calendar, Clock, ArrowRight, BookOpen, Diamond, Wifi, WifiOff, AlertTriangle } from "lucide-react"
...
export default function HomeBlogSection() {
  ...
  const { isConnected, updateCount } = useBlogUpdates({
    ...
    onPermanentDeletion: (data) => {
      console.log(`Post permanently deleted: ${data.deletedSlug}`)
    },
  })
        ...
        {error && (
          <motion.div className="text-center mb-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="bg-red-500/20 text-red-400 border border-red-400/30 rounded-lg p-6 max-w-md mx-auto">
              ...
              <p className="text-sm mb-4">Please check your connection and try again later.</p>
              <Link href="/blog">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center gap-4 text-sm text-gray-400 mb-3">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span itemProp="timeRequired">{post.readingTime || 5} min read</span>
                        </div>
                      </div>
                      ...
                      <p className="text-gray-300 mb-4 line-clamp-3" itemProp="abstract">
                        {post.intro || "No description available."}
                      </p>
